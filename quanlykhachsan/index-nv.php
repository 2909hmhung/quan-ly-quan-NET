...
<div class="row">
	...
	?>
				<div class="col-xl-2 col-md-4 col-6 mb-4"data-aos="zoom-in">
					<div class="card">
						<img src="./assets/img/off.png" width="100px" class="card-img-top" alt="Phòng đang gặp sự cố">
						<div class="card-body">
				...
				?>
						<div class="col-xl-2 col-md-4 col-6 mb-4" data-aos="zoom-in">
							<a class="card" href="./ql-giao-dich-nv.php?may=<?= $maytinh['id'] ?>">
								<img src="./assets/img/checkin.png" width="100px" class="card-img-top" alt="Phòng đang sử dụng">
								<div class="card-body">
					...
					?>
						<div class="col-xl-2 col-md-4 col-6 mb-4" data-aos="zoom-in">
							<a class="card text-center" href="./them-giao-dich-nv.php?may=<?= $maytinh['id'] ?>">
								<img src="./assets/img/on.png" width="100px" class="card-img-top" alt="Phòng trống">
								<div class="card-body">
									<p class="font-weight-bold text-primary text-center"><?= $maytinh['tenmay'] ?></p>
