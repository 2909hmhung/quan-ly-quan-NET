...
<form action="" method="post" class="row mb-3">
    <div class="col-5">
        <label for="tenphong" class="form-label">Tên máy: </label>
    ...
    ?>
            <div class="col-xl-2 col-md-6 mb-4">
                <div class="card text-center">
                    <img src="./assets/img/off.png" width="100px" class="card-img-top" alt="máy hỏng">
        ...
        ?>
            <div class="col-xl-2 col-md-6 mb-4">
                <div class="card text-center">
                    <img src="./assets/img/on.png" width="100px" class="card-img-top" alt="máy bình thường">
                    <div class="card-body font-weight-bold text-primary text-center">
                        <div><?= $phong['tenphong'] ?></div>
                        <div>
                            <a href="#" class="btn btn-success" title="Sửa" data-toggle="modal" data-target="#exampleModal" data-tenphong="<?= $phong['tenphong'] ?>" data-tinhtrang="<?= $phong['tenphong'] ?>" data-id="<?= $phong['id'] ?>"><i class="fa fa-pencil"></i></a>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        <label for="suatenphong" class="form-label">Tên máy: </label>
                        <input type="hidden" name="suaid" id="suaid">
                        <input type="text" name="suatenphong" id="suatenphong" class="form-control">
                    </div>
                    <div class="form-group">
